...
let txtNumber = document.getElementById("InputTel");
let txtMensaje = document.getElementById("InputMensaje");
...
function validarEmail() {
    ...
    return validcorreo.test(txtEmail.value);
}
...
btnEnviar.addEventListener("click", function (event) {
    ...
    if (validarEnvio()) {
        ...
        emailjs.send('service_rowwba8', 'template_vur5t3t', templateParams)
